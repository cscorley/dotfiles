...
sudo scutil --set ComputerName "bocmaxima"
sudo scutil --set HostName "bocmaxima"
sudo scutil --set LocalHostName "bocmaxima"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "bocmaxima"
